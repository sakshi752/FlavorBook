...
import { deleteRecipe, getAllRecipes, getRecipesOfUser, getUserOfRecipe, newRecipe, updateRecipe, viewRecipe } from "../controllers/recipe.js";
...
router.get("/:userId",getUserOfRecipe)
